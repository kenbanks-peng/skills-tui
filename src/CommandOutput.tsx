...
export function CommandOutput({ command, focused, onBack }: CommandOutputProps) {
  ...
  return (
    <box flexDirection="column" flexGrow={1} border borderStyle={focused ? "double" : "rounded"} borderColor={focused ? theme.green : theme.surface2} padding={1} title=" Output ">
      {!command ? (
        ...
        <box flexDirection="column" flexGrow={1}>
          ...
          {!isRunning && exitCode !== null && (
            <box marginTop={1} paddingLeft={1} flexDirection="row" justifyContent="space-between" paddingRight={1}>
